...
#define EXTRACT_RVC_ADDI4SPN_IMM(x)                                            \
    ((RV_X(x, 6, 1) << 2) | (RV_X(x, 5, 1) << 3) | (RV_X(x, 11, 2) << 4)       \
     | (RV_X(x, 7, 4) << 6))
...
#define EXTRACT_RVC_J_IMM(x)                                                   \
    ((RV_X(x, 3, 3) << 1) | (RV_X(x, 11, 1) << 4) | (RV_X(x, 2, 1) << 5)       \
     | (RV_X(x, 7, 1) << 6) | (RV_X(x, 6, 1) << 7) | (RV_X(x, 9, 2) << 8)      \
     | (RV_X(x, 8, 1) << 10) | (-RV_X(x, 12, 1) << 11))

#define EXTRACT_RVC_ADDI16SP_IMM(x)                                            \
    ((RV_X(x, 6, 1) << 4) | (RV_X(x, 2, 1) << 5) | (RV_X(x, 5, 1) << 6)        \
     | (RV_X(x, 3, 2) << 7) | (-RV_X(x, 12, 1) << 9))
#define EXTRACT_RVC_LUI_IMM(x) (EXTRACT_RVC_IMM(x) << RISCV_IMM_BITS)
#define EXTRACT_RVC_B_IMM(x)                                                   \
    ((RV_X(x, 3, 2) << 1) | (RV_X(x, 10, 2) << 3) | (RV_X(x, 2, 1) << 5)       \
     | (RV_X(x, 5, 2) << 6) | (-RV_X(x, 12, 1) << 8))
#define EXTRACT_RVC_J_IMM(x)                                                   \
    ((RV_X(x, 3, 3) << 1) | (RV_X(x, 11, 1) << 4) | (RV_X(x, 2, 1) << 5)       \
     | (RV_X(x, 7, 1) << 6) | (RV_X(x, 6, 1) << 7) | (RV_X(x, 9, 2) << 8)      \
     | (RV_X(x, 8, 1) << 10) | (-RV_X(x, 12, 1) << 11))
